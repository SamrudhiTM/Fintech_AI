...
exports.updateTransactionSchema = exports.createTransactionSchema = exports.baseTransactionSchema = exports.transactionIdSchema = void 0;
...
exports.baseTransactionSchema = zod_1.z.object({
    ...
    date: zod_1.z
        ...
        .transform((val) => new Date(val)), // takes both nput at last it converts to date
